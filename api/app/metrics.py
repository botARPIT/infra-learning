...
def get_prometheus_metrics():
    ...
    jobs_completed_total.set(metrics["jobs_completed_current"])
    
    jobs_failed_total.set(metrics["jobs_failed_current"])
    
    jobs_retried_total.set(metrics["jobs_retried_current"])
